...
import '../index.css';
import pdf from '../assets/EbadResume.pdf';
const Hero2 = () => {
  const handleClick = () => {
      ...
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between pl-1 lg:pl-28">
        <div className="lg:w-1/2 mb-6 lg:mb-0 p-0 md:p-20">
          ...
          <p className="text-lg lg:text-xl mb-4">
            👋 Hi there! I'm Ebad , a passionate and results-driven React.js
            developer with expertise in building interactive and high-performance front-end applications. 👋
          </p>
          <button
            onClick={() => handleClick()}
